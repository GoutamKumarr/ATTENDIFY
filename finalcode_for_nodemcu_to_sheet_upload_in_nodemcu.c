...
const char *GScriptId = "AKfycbwGGP7rr4CdeXgqlyyB12pvpC5VWiwhJ5BpKJqsxVb4Ckw9wda-3Q7AjusYdLF9gjuf";
//---------------------------------------------------------------------------------------------------------
// Enter network credentials:
const char* ssid     = "Skeleton X";
const char* password = "skeleton@2003";
//---------------------------------------------------------------------------------------------------------
